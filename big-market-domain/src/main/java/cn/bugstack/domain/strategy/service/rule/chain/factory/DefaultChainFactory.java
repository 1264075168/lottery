...
public class DefaultChainFactory {
    ...
    public ILogicChain openLogicChain(Long strategyId) { //一个开启责任链得方法
        ...
        ILogicChain logicChain = logicChainGroup.get(ruleModels[0]);//类似指针，定义第一个责任链节点
    ...
    @AllArgsConstructor
    @NoArgsConstructor
    public static class StrategyAwardVO {//抽奖的时候返回这个**************
        /** 抽奖奖品ID - 内部流转使用 */
