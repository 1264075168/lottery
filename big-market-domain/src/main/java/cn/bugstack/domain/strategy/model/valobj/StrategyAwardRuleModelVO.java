...
public class StrategyAwardRuleModelVO {
     ...
     */
    public String[] raffleCenterRuleModelList() {//中置
        ...
        return ruleModelList.toArray(new String[0]);//把rule_models中的（rule_lock,rule_luck_award）拆分如果存在rule_lock就把他存到数组中
    }

    public String[] raffleAfterRuleModelList() {//后置
        List<String> ruleModelList = new ArrayList<>();
        String[] ruleModelValues = ruleModels.split(Constants.SPLIT);
        for (String ruleModelValue : ruleModelValues) {
